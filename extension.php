...
if ($result->num_rows == 0) {
    $url = 'https://api.openweathermap.org/data/2.5/weather?q=' . $_GET['City'] . '&appid=64b172b9026bc2d101fb8a686d3ea89a&units=metric';
    ...
    $sql = "INSERT INTO weather (Weather_condition, Weather_description, Weather_temperature, Weather_wind, weather_time, City, Humidity, Direction_of_wind, Pressure, Icon)
    VALUES('{$weather_condition}','{$weather_description}', {$weather_temperature}, {$weather_wind}, '{$weather_time}', '{$city}', '{$humidity}', '{$direction_of_wind}', '{$pressure}', '{$icon}')";
